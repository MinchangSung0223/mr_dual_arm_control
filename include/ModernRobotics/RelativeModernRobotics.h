...
namespace relmr {
    typedef Eigen::Matrix<double, RELJOINTNUM, 1> JVec;
    typedef Eigen::Matrix<double, 4, 4> SE3;
    typedef Eigen::Matrix<double, 3, 3> SO3;
    typedef Eigen::Matrix<double, 4, 4> se3;
    typedef Eigen::Matrix<double, 3, 3> so3;
    typedef Eigen::Matrix<double, 6, RELJOINTNUM> ScrewList;
    typedef Eigen::Matrix<double, 6, RELJOINTNUM> Jacobian;
    typedef Eigen::Matrix<double, RELJOINTNUM,6 > pinvJacobian;
    typedef Eigen::Matrix<double, 6*RELJOINTNUM, RELJOINTNUM> DerivativeJacobianVec;
    typedef Eigen::Matrix<double, 6*RELJOINTNUM, 1> vecJVec;
